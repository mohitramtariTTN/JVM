...
public class BOI implements Bank{
    ...
    public void writeBoiTransactions(String operation, double amount){
        try(FileWriter file = new FileWriter("writeBoiTransactions.txt",true)){
    ...
    public static void getDetails(){
        ...
        System.out.println("Bank Slogan : " + "Khayal Aapka");
    ...
    public void depositMoney(){
        ...
        writeBoiTransactions("Deposit",amountDeposited);
    }
    ...
    public void withdrawMoney(){
        ...
        try {
            ...
            System.out.println("Your updated balance is " + this.amount);
            writeBoiTransactions("Withdraw",amountWithdrawn);
