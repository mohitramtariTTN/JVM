...
public class ICICI implements Bank{
    ...
    public void writeIciciTransactions(String operation, double amount){
        try(FileWriter file = new FileWriter("writeIciciTransactions.txt",true)){
    ...
    public void depositMoney(){
        ...
        writeIciciTransactions("Deposit",amountDeposited);
    }
    ...
    public void withdrawMoney(){
        ...
        try {
            ...
            System.out.println("Your updated balance is " + this.amount);
            writeIciciTransactions("Withdraw",amountWithdrawn);
